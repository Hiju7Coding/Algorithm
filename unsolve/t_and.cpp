...
/* ------------------ problem ------------------
Cho n số nguyên dương, nhiệm vụ của bạn là tìm 2 số nguyên ai và aj (i < j )sao cho ai & aj là lớn nhất.
Input: 
- Dòng 1: Một số nguyên dương n ( 1 <= n <= 3.105).
- Dòng 2: n số nguyên dương ai ( ai <= 109).
Output: 
Một dòng duy nhất là đáp án bài toán.
*/
// link: http://upcoder.xyz/'index.php/7f45401ef0fa4cdfb19374ff3618ccbd4bd64de20ecd846175bb527f382edbe3/jytsG''wrcrLKv~4y7'jqKOx&SiT'rrrhmNBx'yxfpky'99-~'?fNM8Me:a-E6~g~5i7d7C89F_2jhje@E%27?Pi3/41706008f9c4a76919aedff81d8977cd08bbdafd8335a8df8b56734f462b2b8c
/* ----------------- test case -----------------
Ví dụ:
Input
10
12 6 7 6 8 3 1 7 6 10
Output
8
Giải thích:
10 & 8  = 8 là lớn nhất có thể.
*/
using namespace std;
/*
