...
/*
Cho n số nguyên dương, nhiệm vụ của bạn là tìm một số x nhỏ nhất mà từ n số trên bạn không thể tạo ra số x bằng cách cộng một vài số hoặc tất cả n số nguyên dương kể trên.
Input:
- Dòng 1: số nguyên dương n ( 1 <= n <= 2.105).
- Dòng 2: n số nguyên dương ai (1<= a <= 109)
Output:
